...
public class OrderCardTest {
    ...
    void shouldSendForm() {
        ...
        form.findElement(By.cssSelector("[data-test-id='name'] input")).sendKeys("Горюнова Дарья");
        form.findElement(By.cssSelector("[data-test-id='phone'] input")).sendKeys("+79531111111");
